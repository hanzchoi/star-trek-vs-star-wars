The buttons have the following format "<choice> | <clicks>"
The Star Wars button is initialized at 20, the Star Trek button is initialized at 40
When a button is clicked, its counter increases by 1
...
A button that has not been clicked has the CSS class name "unselected"
